...
class Beauty_Salon_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <div class="social-icon-search">
                    <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'beauty-salon-spa' ); ?>">
                </div>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $beauty_salon_font_awesome_icon_array = beauty_salon_font_awesome_icon_array();
                    foreach ($beauty_salon_font_awesome_icon_array as $beauty_salon_font_awesome_icon) {
                            $icon_class = $this->value() == $beauty_salon_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($beauty_salon_font_awesome_icon).'"></i>
                            <span class="beauty-salon-social-class">'.esc_attr($beauty_salon_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function beauty_salon_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'beauty-salon-customizer-script', esc_url(get_template_directory_uri()).'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'beauty_salon_customizer_script' );

if(!function_exists('beauty_salon_font_awesome_icon_array')){
    function beauty_salon_font_awesome_icon_array(){
