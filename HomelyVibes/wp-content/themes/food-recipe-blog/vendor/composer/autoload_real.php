...
class Food_Recipe_Blog_ComposerAutoloaderInit75f95ca3778976eb5c1bf35fe42ac3d4
{
    private static $loader;

    public static function food_recipe_blog_loadClassLoader($class)
    {
    ...
    public static function food_recipe_blog_getLoader()
    {
        if (null !== self::$loader) {
            return self::$loader;
        }
