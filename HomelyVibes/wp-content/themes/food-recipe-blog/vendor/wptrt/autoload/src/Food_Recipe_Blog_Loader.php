...
class Food_Recipe_Blog_Loader {
	 ...
	 * @return void
	 */
	public function food_recipe_blog_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function food_recipe_blog_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function food_recipe_blog_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function food_recipe_blog_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->food_recipe_blog_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function food_recipe_blog_load( $class ) {
